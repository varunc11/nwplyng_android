...
public class AddFriendAdapter extends BaseAdapter {
	...
	String auth_token = "";
	AddFriend listActivity;
	
	public AddFriendAdapter(Context context,Activity activity) {
	...
	public AddFriendAdapter(Context context,Activity activity,AddFriend listActivity) {
	...
	public View getView(final int index, View view, ViewGroup parent) {
		...
		rel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				try{
					listActivity.isLoadingOver = true;
				}catch (Exception e) {
					e.printStackTrace();
				}
