...
public class SocialNetworkFriendsListAdapter extends BaseAdapter {
	...
	String auth_token = "";
	SocialNetworkFriendsList listActivity;
	
	public SocialNetworkFriendsListAdapter(Context context,Activity activity) {
	...
	public SocialNetworkFriendsListAdapter(Context context,Activity activity,SocialNetworkFriendsList listActivity) {
