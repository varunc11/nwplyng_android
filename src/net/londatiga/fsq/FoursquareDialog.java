...
public class FoursquareDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner.setMessage("Connecting...");
        ...
        addContentView(mContent, new FrameLayout.LayoutParams((int) display.getWidth(),
	 ...
	 private void setUpTitle() {
	        ...
	        Drawable icon = getContext().getResources().getDrawable(R.drawable.foursquare_dialog_logo);
